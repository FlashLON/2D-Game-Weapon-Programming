...
export const ATTRIBUTES: Record<string, AttributeConfig> = {
    ...
    aura_damage: {
        id: 'aura_damage',
        name: 'Damage Aura',
        description: 'Increases all damage dealt by the player. (Deep Red Pulse)',
        isBase: false,
        isAura: true,
        startLimit: 1.1,
        maxLimit: 3.5,
    ...
    aura_gravity: {
        id: 'aura_gravity',
        name: 'Gravity Aura',
        description: 'Amplifies knockback, vortex, and gravity-based effects. (Purple Warp)',
        isBase: false,
        isAura: true,
        startLimit: 1.5,
        maxLimit: 5.0,
    ...
    aura_corruption: {
        ...
        description: 'Enemies near you continuously take damage over time. (Toxic Green Mist)',
        isBase: false,
        isAura: true,
        startLimit: 20,
        maxLimit: 400,
    ...
    aura_execution: {
        id: 'aura_execution',
        name: 'Execution Aura',
        description: 'Increases damage dealt to low-health enemies within radius. (Orange Halo)',
        isBase: false,
        isAura: true,
        startLimit: 1.2,
        maxLimit: 3.0,
    ...
    aura_chaos: {
        id: 'aura_chaos',
        name: 'Chaos Aura',
        description: 'Randomly enhances projectile damage, speed, or size. (RGB Glitch)',
        isBase: false,
        isAura: true,
        startLimit: 1.2,
        maxLimit: 4.0,
    ...
    aura_control: {
        id: 'aura_control',
        name: 'Control Aura',
        description: 'Reduces enemy movement speed and resistance within radius. (Ice Blue Field)',
        isBase: false,
        isAura: true,
        startLimit: 0.8,
        maxLimit: 0.2,
    ...
    aura_vampire: {
        id: 'aura_vampire',
        name: 'Vampiric Aura',
        description: 'A portion of damage dealt to enemies returns as health. (Crimson Pulse)',
        isBase: false,
        isAura: true,
        startLimit: 0.05,
        maxLimit: 0.4,
    ...
    aura_precision: {
        id: 'aura_precision',
        name: 'Precision Aura',
        description: 'Increases critical chance and improves Focus Fire. (White Target Grid)',
        isBase: false,
        isAura: true,
        startLimit: 1.1,
        maxLimit: 2.5,
